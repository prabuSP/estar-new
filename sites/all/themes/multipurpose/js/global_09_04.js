jQuery( function($) {
	...
	$(document).ready(function(){
		...
		$( "#user-login .user_login_page .login_content_Section li" ).wrapInner( "<span></span>" );
		 ...
		 $( "body.page-assessment-details-form" ).addClass("red_theme");
		 $( "body.page-new-assessment" ).addClass("red_theme");
		 $( "body.page-assessment-details" ).addClass("red_theme");
		 $( "body.page-assessment-form" ).addClass("red_theme");
		 $( "body.page-substance-details" ).addClass("red_theme");
		 ...
		 $( "body.page-capacity-list #capacityDataLists" ).addClass("model_list_Section");
		 $( "body.page-capacity .capacityDataLists_new" ).addClass("model_list_Section");

		 $( "#assessment-details-form .assessment_page .assessment-nxt-btn" ).addClass("detail_list_btn");
		 $( "#planning-details-form .planning-nxt-btn" ).addClass("detail_list_btn");
		 $( ".page-implementation .capacity-nxt-btn" ).addClass("detail_list_btn");
		 $( ".page-capacity-list .capacity_btn_section .capacity-nxt-btn" ).addClass("detail_list_btn");
...
$('.mouManagerClass').change(function(){
			...
			$.ajax({
							 ...
							 success: function(res) {
									 ...
									 $('#edit-mail-subject').val('Hi Mr. '+userDetails[0]+' Volunteer here is your MOU');
