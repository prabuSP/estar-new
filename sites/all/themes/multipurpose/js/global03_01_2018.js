...
$(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td class="table_heading"><div class="ibtnDel button button_remove"><input type="button" class=" btn btn-md btn-danger "  value="Remove"></div></td>';
        newRow.append(cols);
...
$(document).ready(function () {
    ...
    $("#addrow-list").on("click", function () {
        ...
        cols += '<td class="table_heading multiple_textarea"><div class="ibtnDel-list button button_remove"><input type="button" class=" btn btn-md btn-danger "   value="Remove"></div></td>';
        newRow.append(cols);
...
function checkAllRadioFunc(element,eCount){
   var checked = $(element).prop('checked');
   $('#logicmodel_inter_con_'+eCount).parent().parent().find('input:radio').not('.unCheckLogicModel').prop('checked', checked);
}
...
{ 
	     ...
	     if(csap6Val=="Alternative Activities"){
				...
				$("#media").hide();
		  	    $("#social_media").hide();
		  	    $("#media_lenght").show();//lenght service,address,location ,number of adults show
		 } 
	  ...
	  var infomationval=element.value;
	     if(infomationval=="None"){
		  ...
		  if(infomationval=="Media"){
		       $("#media").show();
		       $("#social_media").hide();
		   	   $("#media_lenght").hide();//lenght service,address,location ,number of adults hide
		 }
