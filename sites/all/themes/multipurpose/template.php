...
*/
function multipurpose_theme() {
  $items = array();
  
  $items['user_login'] = array(
    'render element' => 'form',
    'path' => drupal_get_path('theme', 'multipurpose') . '/templates',
    'template' => 'user-login-form',
    'preprocess functions' => array(
       'multipurpose_preprocess_user_login'
    ),
  );
  $items['user_register_form'] = array(
    ...
    'preprocess functions' => array(
      'multipurpose_preprocess_user_register_form'
    ),
  );
  $items['user_pass'] = array(
    ...
    'template' => 'user-pass',
    'preprocess functions' => array(
      'multipurpose_preprocess_user_pass'
    ),
  );
  return $items;
}
